...
class BotWriter_Woo_AI {
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script( 'bw-woo-ai-js', 'bw_woo_ai', [
            ...
            'i18n'          => [
                ...
                'woo_activity_this_month' => __( 'This month', 'botwriter' ),
                'woo_activity_previous'   => __( 'Previous month', 'botwriter' ),
                /* translators: %d: number of months included in the activity total */
                'woo_activity_period'     => __( 'Last %d months', 'botwriter' ),
                'woo_activity_note'       => __( 'WooCommerce AI requests. Each generated field is recorded as one request.', 'botwriter' ),
                'woo_activity_unavailable'=> __( 'WooCommerce AI activity is temporarily unavailable.', 'botwriter' ),
    ...
    private function register_ajax_handlers() {
        $actions = [
            ...
            'bw_woo_ai_get_usage'          => [ $this->history,   'ajax_get_usage' ],
